...
@section('title','Queue List | SmsBox')
            ...
            <div class="col-md-9">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title">{{trans('customer.queue')}}</h3>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-hover table-striped">
                                ...
                                <th>{{trans('customer.sent_at')}}</th>
                                </td>
                                </thead>
                                <tbody>
                                @foreach($queuesList as $message)
                                    <tr>
                                        <td>
                                        ...
                                        <td class="mailbox-date">
                                            @if($message->schedule_completed=='yes' && $message->delivered_at==null)
                                                <span class="text-danger">{{trans('customer.failed')}}</span>
                                                @else
                            ...
                            <div class="float-right"> {{$queuesList->links("pagination::bootstrap-4")}} </div>
                            <!-- /.table -->
                        </div>
                        <!-- /.mail-box-messages -->
                    </div>
