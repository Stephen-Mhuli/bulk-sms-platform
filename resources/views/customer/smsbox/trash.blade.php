                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body p-0">
                            <div class="mailbox-controls">
                                ...
                                <div class="btn-group">
                                    <button data-message="{{trans('customer.messages.warning_message_permanently_deleted')}}"
                                            data-action="{{route('customer.smsbox.remove.trash')}}"
                                            data-input=''
                                ...
                                <!-- /.btn-group -->
                                <button type="button" class="btn btn-default btn-sm d-none"><i class="fas fa-sync-alt"></i></button>
